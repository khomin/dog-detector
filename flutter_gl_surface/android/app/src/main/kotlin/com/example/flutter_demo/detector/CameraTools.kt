...
class CameraInfo(val size: List<Size>, val facing: CameraFacing) {}
...
class CameraTools(val context: Context, val windowManager: WindowManager) {
    ...
    fun getCameraInfo(id: String, context: Context): CameraInfo {
        try {
            val cameraManager = context.getSystemService(Context.CAMERA_SERVICE) as CameraManager
            ...
            return CameraInfo(supportedResolutions, when (facing) {
        ...
        return CameraInfo(emptyList(), CameraFacing.Back)
    }
